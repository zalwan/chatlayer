...
| -------------------------- | ------- | ----------------------------------------------------------------------------------- |
| `@zalwan/chatlayer`        | 0.1.7   | Headless `createChat`, `ChatTransport`, NDJSON protocol, Svelte-compatible stores   |
| `@zalwan/chatlayer-svelte` | 0.1.7   | `<ChatWidget layout>`, `MessageList`, `Message`, `Composer`, Markdown + code blocks |
