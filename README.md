...
| -------------------------- | ------- | ----------------------------------------------------------------------------------- |
| `@zalwan/chatlayer`        | 0.1.6   | Headless `createChat`, `ChatTransport`, NDJSON protocol, Svelte-compatible stores   |
| `@zalwan/chatlayer-svelte` | 0.1.6   | `<ChatWidget layout>`, `MessageList`, `Message`, `Composer`, Markdown + code blocks |
